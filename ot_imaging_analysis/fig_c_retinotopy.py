...
all_responses = pooled_data.loc[:,
    [f"rel_{i}" for i in range(len(stim_thetas))]].values.T
...
all_axs = [fig_c.add_axes((m_xpos + 0.5 * i * xside, m_ypos,
    ...
    if g_i == 0:
        ...
        for labels, bar_pos_y in zip([["caud-rost", "l-r"], ["vent-dors", "l-r"]],
            ...
            axs.plot([bar_pos_x, bar_pos_x, bar_pos_x + b_len],
                     [bar_pos_y - b_len, bar_pos_y, bar_pos_y], lw=0.5,
                     c=(0.3,) * 3)
            axs.text(bar_pos_x, bar_pos_y - b_len / 2, labels[0], ha="right",
                     va="center",
                     rotation='vertical', fontsize=8)
            axs.text(bar_pos_x + b_len / 2, bar_pos_y + 10, labels[1], ha="center",
